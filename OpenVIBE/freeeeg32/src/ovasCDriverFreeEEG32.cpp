...
#define AD7770_VREF 1.25  // reference voltage for ADC in AD7770.  set by its hardware
...
#define AD7770_GAIN 32.0  //assumed gain setting for AD7770.  set by its Arduino code
